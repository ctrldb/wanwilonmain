...
function getAll(client, message) {
    const embed = new MessageEmbed()
        .setColor("#FFDFD3")
        .setThumbnail("https://images-ext-2.discordapp.net/external/Wm3ZLU7b_2qOCdWNGgxWXRarUshjaylKNsu65LyMc20/https/phonoteka.org/uploads/posts/2021-06/1624420742_21-phonoteka_org-p-krasnie-anime-oboi-na-telefon-krasivo-21.jpg?width=960&height=600")
        .setTitle('Help Menu')
